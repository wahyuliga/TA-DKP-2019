...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="">
          <a href="index.php?page=pinjaman">
            <i class="fa fa-database"></i> <span>Data Peminjaman</span>
          </a>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Tugas Akhir &copy; 2019 <a href="#">Wahyu Liga Saputra</a>.</strong> All rights
    reserved.
  </footer>
